...
function Intro() {
  return (
     ...
     <div className='w-2/5 text-center'>
        ...
        <div >
            <button className='bg-transparent px-3 py-2 hover:bg-[#6F757C] text-[#FEF7EE] text-md font-semibold rounded-lg mx-4 my-6 ' style={{}}>All Products</button>

            <button className='bg-transparent px-3 py-2 hover:bg-[#6F757C] text-[#FEF7EE] text-md font-semibold rounded-lg mx-4 my-6 ' >Available Now</button>
        </div>
     </div>
     </>
  )
